...
class TestUserInstantiation(unittest.TestCase):
    ...
    def test_email_attr(self):
        """Test that User has the email attribute initialized as an empty string."""
        user = User()
        self.assertTrue(hasattr(user, "email"))
        self.assertEqual(user.email, "")

    def test_password_attr(self):
        """Test that User has the password attribute initialized as an empty string."""
        user = User()
        self.assertTrue(hasattr(user, "password"))
        self.assertEqual(user.password, "")

    def test_first_name_attr(self):
        """Test that User has the first_name attribute initialized as an empty string."""
        user = User()
        self.assertTrue(hasattr(user, "first_name"))
        self.assertEqual(user.first_name, "")

    def test_last_name_attr(self):
        """Test that User has the last_name attribute initialized as an empty string."""
        user = User()
